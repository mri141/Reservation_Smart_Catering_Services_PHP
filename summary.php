			...
			<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="widget-content">
                  <div class="padd" style="height:650px">
                    ...
                    <h3 style="text-align:center">Smart Catering Services</h3>
<h4 style="text-align:center">Dhaka City</h4>
<h4 style="text-align:center">Tel. No. : 435-00787</h4>
<h4 style="text-align:center">Email : smartcat@gmail.com</h4>
<h4 style="text-align:center">Facebook : facebook.com/smartcat</h4>
<hr>
