                ...
                <div class="widget-content">
                  ...
                  <div class="padd">
                             ...
                             <div class="support-contact">
                                ...
                                <hr />
                                <p><i class="fa fa-envelope"></i>&nbsp; Email<strong>:</strong> smartcat@gmail.com</p>
                                <hr />
                                <p><i class="fa fa-home"></i>&nbsp; Address<strong>:</strong> Dhaka City </p>
                <hr />
        <p><i class="fa fa-facebook"></i>&nbsp; Facebook<strong>:</strong> facebook.com/smartcat </p>
                <hr />              
                                <!-- Button -->
